...
4. Duplicate Analysis: Identifies duplicate files between directories.
...
def parse_arguments():
    ...
    common_parser.add_argument(
        "--base-dir", required=True, help="Base directory containing original files"
    )
    common_parser.add_argument(
        "--max-width",
        type=int,
    ...
    common_parser.add_argument(
        ...
        help="Checksum info file to read from. Default: checksums.txt",
    )
    ...
    search_parser = subparsers.add_parser(
        ...
        help="🔎 Search for duplicate files without saving checksum information",
    )
    ...
    checksum_parser = subparsers.add_parser(
        "checksum",
        parents=[common_parser],
        help="🧮 Calculate checksums, find duplicates, and save checksum information to a file",
    )
    ...
    delete_parser = subparsers.add_parser(
        "delete",
        parents=[common_parser],
        help="🗑️ Delete duplicate files based on checksum info file",
    )
...
# [Rest of the code remains the same as provided in your latest version]
